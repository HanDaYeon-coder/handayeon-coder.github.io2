...
처음에는 프론트(크롬 익스텐션)에서 모든 인증 과정을 수행하려고 했으나, 다음의 이유로 **3번의 인증 과정(프론트+백엔드)**을 선택하게 되었습니다.

- 프론트에서 인증 과정 수행하는 과정 
➡️ 크롬 익스텐션 OAuth2 관련 라이브러리 : chorme.identity
![](https://velog.velcdn.com/images/da_na/post/2e6485c1-a3ac-4ada-aa11-b682231df9e9/image.png)
...
![](https://velog.velcdn.com/images/da_na/post/58b60a49-8df0-44a2-a241-2c7786d3013b/image.png)https://developer.chrome.com/docs/extensions/mv3/intro/
...
➡️ 백엔드 Spring에서는 인증 절차를 간편하게 해주는 Spring Security를 사용하면, 웹 공격으로 부터 안전하게 지켜줄 수 있는 작업을 수행해준다. (추후, Spring Security 관련 글에서 더 자세하게 이야기 하겠습니다.)
...
![](https://velog.velcdn.com/images/da_na/post/bf4b5528-cbc9-46e9-a849-2f0d4e6e4b88/image.png)

6. Google API Server는 해당 클라이언트 ID의 리다렉션 URI에 인가코드(Authorization code)를 제공해줍니다.![](https://velog.velcdn.com/images/da_na/post/0644050e-1525-4b10-a36f-bdcb3c216d98/image.png)
